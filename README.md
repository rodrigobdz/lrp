...
- Plaintext:
  ...
  > Rodrigo Bermúdez Schettino. (2022). rodrigobdz/lrp: v0.1.5 (v0.1.5). Zenodo. https://doi.org/10.5281/zenodo.6821225

- BibTeX:

  ```text
  @software{rodrigo_bermudez_schettino_2022_6821225,
    ...
    publisher    = {Zenodo},
    version      = {v0.1.5},
    doi          = {10.5281/zenodo.6821225},
    url          = {https://doi.org/10.5281/zenodo.6821225}
  }
  ```
